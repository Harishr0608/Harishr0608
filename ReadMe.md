# 💫 About Me:
🎓 Strong foundation in software development principles.<br>🐍 Proficient in building efficient and scalable software using Python and Object-Oriented Programming.<br>🗄️ Eager to apply data structures and algorithms to solve real-world problems.<br>🪄 Adept at querying and manipulating data using SQL.<br>🧠 Currently learning and applying AI techniques for data analysis and model building.<br>📈 Looking to work and learn alongside data at companies.<br>💡 Eager to explore new techniques and concepts in the vast data world.<br>📚 Committed to continuous learning and staying updated in the dynamic field of data science.<br><br>💎 Top Skills: <br>[Python, OOPs Concepts, MySQL, Tableau, Exploratory Data Analysis(EDA), Feature Engineering, Statistical Analysis, Probability, Machine Learning, Feature Selection, Data Visualisation, ETL(Extract, Transform, Load)]<br><br><br>Connect with me!<br><br>📩 Mail: harishr0608@gmail.com (he/him)<br><br>
